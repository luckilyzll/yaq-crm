        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="派单类型">
              <a-select v-decorator="['operatorSchema',validatorRules.operatorSchema]"
                        placeholder="请选择派单类型" @change="changeOperatorSchema">
          ...
          <a-col :span="12">
            <a-form-item label="自家仓库">
              <a-select v-decorator="['warehouseId',validatorRules.warehouseId]" @change="types"
                        placeholder="请选择自家仓库">
            ...
            <a-form-item label="自家库位">
              <a-select v-decorator="['storageLocationId',validatorRules.storageLocationId]" id="sl"
                ...
                <template v-for="storageLocation in storageLocations">
                  <a-select-option v-bind:value="storageLocation.id">
          ...
          <a-col :span="12">
            <a-form-item label="员工">
              <a-select
                ...
                <a-select-option v-for="(role,roleindex) in users" :key="roleindex.toString()"
                                 :value="role.id">
                  {{ role.realname }}
                </a-select-option>
              </a-select>
          ...
          <a-col :span="12">
            <a-form-item label="车辆">
              <a-select
                ...
                :getPopupContainer="(target) => target.parentNode">
                <a-select-option v-for="(role,roleindex) in vehicles" :key="roleindex.toString()"
                                 :value="role.license">
                  {{ role.license }}
                </a-select-option>
              </a-select>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="任务日期">
              <j-date v-decorator="['taskTime',validatorRules.taskTime]" :showTime="true"
          ...
          <a-col :span="12">
            <a-button @click="queryCler" type="primary"
                      style="width: 100px;float:right;margin-right: 230px;">
              清空
            </a-button>
