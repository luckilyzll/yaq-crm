    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form" style="margin-top: 15px">
        ...
        <a-form-item label="库位名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['storageLocationName',validatorRules.storageLocationName]"
                   placeholder="请输入库位名称"></a-input>
        </a-form-item>
        <a-form-item label="库位容积" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['storageLocationVolume',validatorRules.storageLocationVolume]"
                          placeholder="请输入库位容积" style="width: 100%"/>
        </a-form-item>
