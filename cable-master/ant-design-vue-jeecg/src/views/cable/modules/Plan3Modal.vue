    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form" style="margin-left: 25px;margin-top: 20px">
        ...
        <a-form-item label="新品类型" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
          <a-select v-decorator="['planType', validatorRules.planType]" class="inupt_b_a" style="width: 220px"
                    placeholder="请选择所属类型">
        ...
        <a-form-item label="工程账号" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
          <a-input v-decorator="['projectNo', validatorRules.projectNo]" class="inupt_b_a"
                   style="width: 220px" placeholder="请输入工程账号"></a-input>
        </a-form-item>
        <a-form-item label="工程名称" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
          <a-input v-decorator="['engName', validatorRules.engName]" placeholder="请输入工程名称"
                   style="width: 220px"></a-input>
        </a-form-item>
        <a-form-item label="物料代码" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_c"
                     style="margin-left: -26px">
          <j-search-select-tag placeholder="输入原物料编码"
                               v-decorator="[ 'materialCode',validatorRules.materialCode]"
                               style="width: 220px" class="inupt_b_a" dict="material,serial,serial"
                               :async="true">
          </j-search-select-tag>
        </a-form-item>
        <a-form-item label="物料描述" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
          <a-input v-decorator="['materialDescribe', validatorRules.materialDescribe]" class="inupt_b_a"
                   style="width: 220px" placeholder="请输入物料描述"></a-input>
        </a-form-item>
        <a-form-item label="计量单位" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
          <a-select v-decorator="['measuringUnit', validatorRules.measuringUnit]" class="inupt_b_a"
                    style="width: 220px" @change="types" placeholder="请选择计量单位">
            <template v-for="(materialUnit,index) in materialUnits">
              <a-select-option v-bind:value="materialUnit.itemValue">{{materialUnit.itemText}}
              </a-select-option>
            </template>
          </a-select>
        </a-form-item>
        ...
        <a-form-item label="送货地点" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_a"
                     style="margin-right: 300px">
          <a-input v-decorator="['address']" placeholder="请输入送货地点" style="width: 550px"></a-input>
        </a-form-item>
        <a-form-item label="反馈意见" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_a"
        ...
        <a-form-item label="具体施工日期" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_c">
          <j-date placeholder="请选择具体施工日期" v-decorator="['constructionTime']" class="inupt_b_a"
                  :trigger-change="true"/>
        </a-form-item>
        <a-form-item label="开始送货日期" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_c">
          <j-date placeholder="请选择开始送货日期" v-decorator="['startTime']" class="inupt_b_a"
                  :trigger-change="true"/>
        </a-form-item>
        <a-form-item label="最终到货日期" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_c">
          <j-date placeholder="请选择最终到货日期" v-decorator="['stopTime']" class="inupt_b_a"
                  :trigger-change="true"/>
        </a-form-item>
        <a-form-item label="备注" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_a"
                     style="margin-right: 330px">
        ...
        <a-form-item label="完成状态" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
          <a-select v-decorator="['completeState', validatorRules.completeState]" class="inupt_b_a"
                    style="width: 220px" placeholder="请选择完成状态">
