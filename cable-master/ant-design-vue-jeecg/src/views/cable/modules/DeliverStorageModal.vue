    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="是否异常(字典0正常 1异常)" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['sceneSituation']" placeholder="请输入是否异常(字典0正常 1异常)"
                          style="width: 100%"/>
        </a-form-item>
        ...
        <a-form-item label="入库日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择入库日期" v-decorator="['deliverTime']" :trigger-change="true"
                  style="width: 100%"/>
        </a-form-item>
        ...
        <a-form-item label="更新时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择更新时间" v-decorator="['updateTime']" :trigger-change="true"
                  style="width: 100%"/>
        </a-form-item>
