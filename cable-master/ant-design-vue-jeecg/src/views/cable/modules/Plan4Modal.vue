      ...
      <a-form :form="form" style="margin-top: 20px;margin-left: 25px">
        ...
        <a-form-item label="工程账号" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
          <a-input v-decorator="['projectNo', validatorRules.projectNo]" class="inupt_b_a"
                   style="width: 220px"
                   placeholder="请输入工程账号"></a-input>
        </a-form-item>
        <a-form-item label="工程名称" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
          <a-input v-decorator="['engName', validatorRules.engName]" class="inupt_b_a" style="width: 220px"
                   placeholder="请输入工程名称"></a-input>
        </a-form-item>
        ...
        <a-form-item label="抽取日期" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_c">
          <j-date placeholder="请选择抽取日期" v-decorator="['samplingDate']" class="inupt_b_a"
                  :trigger-change="true"/>
        </a-form-item>
        ...
        <a-form-item label="运检反馈" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_a"
