    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form" style="padding-left: 40px;margin-top: 15px">
        ...
        <div style="margin-bottom: -15px">
          ...
          <a-form-item label="废旧物料编码" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d"
                       style="margin-left: -36px">
            <j-search-select-tag placeholder="输入废旧物料编码"
                                 v-decorator="[ 'wasteMaterialCode',validatorRules.wasteMaterialCode]"
                                 style="width: 220px" class="inupt_b_a" dict="material,serial,serial" :async="true">
            </j-search-select-tag>
          </a-form-item>
          <a-form-item label="废旧物料描述" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d"
                       style="margin-left: -35px">
            <a-input v-decorator="['wasteMaterialText', validatorRules.wasteMaterialText]" placeholder="请输入废旧物料描述"
                     class="inupt_b_a"></a-input>
          </a-form-item>
          <a-form-item label="废旧物料单位" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d"
                       style="margin-left: -35px">
            <a-select v-decorator="['wasteMaterialUnit', validatorRules.wasteMaterialUnit]" placeholder="请选择废旧物料单位"
                      class="inupt_b_a" style="width: 220px">
        ...
        <div style="margin-bottom: -15px">
          <a-form-item label="项目编码" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
            <a-input v-decorator="['projectNo', validatorRules.projectNo]" placeholder="请输入项目编码"
                     class="inupt_b_a"></a-input>
          </a-form-item>
          <a-form-item label="项目名称" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b"
                       style="margin-right: 273px">
            <a-input v-decorator="['projectName', validatorRules.projectName]" placeholder="请输入项目名称" class="inupt_b_a"
                     style="width: 550px"></a-input>
          </a-form-item>
          <a-form-item label="资产编码" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
            <a-input v-decorator="['assetNo', validatorRules.assetNo]" placeholder="请输入资产编码"
                     class="inupt_b_a"></a-input>
          </a-form-item>
        </div>

        <div style="margin-bottom: -15px">
          <a-form-item label="交接单数量" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d"
                       style="margin-left: -35px">
            <a-input v-decorator="['numReceipts', validatorRules.numReceipts]" placeholder="请输入交接单数量" class="inupt_b_a"
                     style="width: 220px"/>
          </a-form-item>
        ...
        <div style="margin-bottom: -15px">
          <a-form-item label="库存点描述" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b"
                       style="margin-right: 272px">
            <a-input v-decorator="['theLocationText']" placeholder="请输入库存点描述" class="inupt_b_a"
                     style="width: 550px"></a-input>
          </a-form-item>

          <a-form-item label="原物料编码" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_c"
                       style="margin-left: -26px">
            <j-search-select-tag placeholder="输入原物料编码" v-decorator="[ 'rawMaterialCode',validatorRules.rawMaterialCode]"
                                 style="width: 220px" class="inupt_b_a" dict="material,serial,serial" :async="true">
            </j-search-select-tag>
          </a-form-item>

          <a-form-item label="原物料描述" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_c"
                       style="margin-left: -30px">
            <a-input v-decorator="['rawMaterialText', validatorRules.rawMaterialText]" placeholder="请输入原物料描述"
                     class="inupt_b_a"></a-input>
          </a-form-item>
        </div>
        <div style="margin-bottom: -15px">
          <a-form-item label="原物料单位" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d"
                       style="margin-left: -35px">
            <a-select v-decorator="['rawMaterialUnit', validatorRules.rawMaterialUnit]" class="inupt_b_a"
                      style="width: 220px" placeholder="请选择原物料单位">
              <template v-for="(materialUnit,index) in materialUnits">
                <a-select-option v-bind:value="materialUnit.itemValue">{{materialUnit.itemText}}</a-select-option>
              </template>
            </a-select>
        ...
        <div style="margin-bottom: -15px">
          ...
          <a-form-item label="交接单创建日期" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d"
                       style="margin-left: -40px">
            <j-date placeholder="请选择交接单创建日期" v-decorator="['deliveryCreateTime']" :trigger-change="true"
                    style="margin-left: 5px" class="inupt_b_a"/>
          </a-form-item>
          <a-form-item label="交接单接收日期" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d"
                       style="margin-left: -35px">
            <j-date placeholder="请选择交接单接收日期" v-decorator="['deliveryReceiveTime']" :trigger-change="true"
                    style="margin-left: 5px" class="inupt_b_a"/>
          </a-form-item>
          <a-form-item label="项目单位联系人" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d"
                       style="margin-left: -35px">
            <a-input v-decorator="['projectContact']" placeholder="请输入项目单位联系人" class="inupt_b_a"
                     style="margin-left: 5px"></a-input>
          </a-form-item>
        </div>
        <div style="margin-bottom: -15px">
        ...
        <div style="margin-bottom: -15px">
          ...
          <a-form-item label="拆除计划说明" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_c"
                       style="margin-right: 230px">
            <a-input v-decorator="['demolitionPlan']" placeholder="请输入拆除计划说明" class="inupt_b_a"
                     style="width: 550px"></a-input>
          </a-form-item>
        ...
        <div style="margin-bottom: -15px">
          ...
          <a-form-item label="工程详细地址" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_c"
                       style="margin-right: 230px">
            <a-input v-decorator="['engineeringAddress']" placeholder="请输入工程详细地址" class="inupt_b_a"
                     style="width: 550px"></a-input>
          </a-form-item>
        ...
        <div style="margin-bottom: -15px">
          ...
          <a-form-item label="计划报废完成时间" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d">
            <j-date placeholder="请选择计划报废完成时间" v-decorator="['plansCompleteTime']" :trigger-change="true"
                    class="inupt_b_a"/>
          </a-form-item>
          <a-form-item label="完成状态" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
            <a-select v-decorator="['completeState', validatorRules.completeState]" placeholder="请选择完成状态"
                      style="width: 218px">
