    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form" style="margin-top: 20px;margin-left: 25px">
        ...
        <a-form-item label="工程项目编号" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_d">
          <a-input v-decorator="['projectNo', validatorRules.projectNo]" placeholder="请输入工程项目编号"
        ...
        <a-form-item label="地址" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_a"
                     style="margin-right: 330px">
        ...
        <a-form-item label="完成状态" :labelCol="labelCol" :wrapperCol="wrapperCol" class="inupt_b">
          <a-select v-decorator="['completeState', validatorRules.completeState]" class="inupt_b_a" style="width: 220px"
                    placeholder="请选择完成状态">
