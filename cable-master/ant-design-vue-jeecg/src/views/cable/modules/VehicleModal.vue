    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="车辆类型" :labelCol="labelCol" :wrapperCol="wrapperCol"
                     style="width: 450px;display: inline-block;margin-bottom: -1px">
        ...
        <a-form-item label="载重" :labelCol="labelCol" :wrapperCol="wrapperCol"
                     style="width: 450px;margin-bottom: -1px">
          <!--          <a-input-number v-decorator="['carryingCapacity']" placeholder="请输入载重" style="width: 100%"/>-->
          <a-input id="zz" v-decorator="['carryingCapacity',  validatorRules.carryingCapacity]"
        ...
        <a-form-item label="发动机号" :labelCol="labelCol" :wrapperCol="wrapperCol"
                     style="width: 450px;margin-bottom: -1px">
          <a-input v-decorator="['engineNumber', validatorRules.engineNumber]"
        ...
        <a-form-item label="备注" :labelCol="labelCol" :wrapperCol="wrapperCol"
                     style="margin-bottom: -2px;margin-top: -1px">
                    <textarea placeholder="请输入备注" v-decorator="[ 'text', validatorRules.text]"
                              class="textar"></textarea>
        </a-form-item>
