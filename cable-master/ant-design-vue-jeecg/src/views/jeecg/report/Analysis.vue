              ...
              <a-col :xl="8" :lg="12" :md="12" :sm="24" :xs="24">
                ...
                <a-card title="快速开始 / 便捷导航" style="margin-bottom: 24px" :bordered="false"
                  ...
                  <div class="item-group">
                    <a-row>
                      <a-col :class="'more-btn'" :span="12"
                             v-for="(item,index) in registerTypeList"
                             :key=" 'registerType'+index ">
                        <a-button @click="goPage(index)" style="margin-bottom:10px" size="small"
                                  type="primary" ghost>{{
                          item.text }}
                        </a-button>
                      </a-col>
                ...
                <a-row>
                  <template v-if="diskInfo && diskInfo.length>0">
                    <a-col :span="12" v-for="(item,index) in diskInfo" :key=" 'diskInfo'+index ">
                      <dash-chart-demo :title="item.name"
                                       :dataSource="item.restPPT"></dash-chart-demo>
                    </a-col>
                  </template>
                </a-row>
              </a-col>
      ...
      <a-card :loading="loading" :class="{ 'anty-list-cust':true }" :bordered="false"
        ...
        <a-tabs default-active-key="1" size="large"
          ...
          <a-tab-pane loading="true" tab="业务流程限时监管" key="1">
            ...
            <a-table :dataSource="dataSource1" size="default" rowKey="id" :columns="columns"
