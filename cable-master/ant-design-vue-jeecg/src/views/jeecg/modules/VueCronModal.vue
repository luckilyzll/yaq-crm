          ...
          <a-radio-group v-model="result.second.cronEvery">
            ...
            <a-row>
              <a-radio value="2">每隔
                ...
                秒执行 从
                <a-input-number size="small" v-model="result.second.incrementStart" :min="0"
            ...
            <a-row>
              ...
              <a-select style="width:354px;" size="small" mode="multiple"
                        v-model="result.second.specificSpecific">
                <a-select-option v-for="(val,index) in 60" :key="index" :value="index">{{ index }}
                </a-select-option>
              </a-select>
            </a-row>
            <a-row>
              <a-radio value="4">周期从
                <a-input-number size="small" v-model="result.second.rangeStart" :min="1"
                                :max="60"></a-input-number>
                到
                <a-input-number size="small" v-model="result.second.rangeEnd" :min="0"
                                :max="59"></a-input-number>
                秒
              </a-radio>
            </a-row>
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.minute.cronEvery">
              ...
              <a-row>
                ...
                <a-select style="width:340px;" size="small" mode="multiple"
              ...
              <a-row>
                <a-radio value="4">周期从
                  <a-input-number size="small" v-model="result.minute.rangeStart" :min="1"
                                  :max="60"></a-input-number>
                  到
                  <a-input-number size="small" v-model="result.minute.rangeEnd" :min="0"
                                  :max="59"></a-input-number>
                  分
                </a-radio>
              </a-row>
            ...
            <a-radio-group v-model="result.hour.cronEvery">
              ...
              <a-row>
                <a-radio value="2">每隔
                  ...
                  小时执行 从
                  <a-input-number size="small" v-model="result.hour.incrementStart" :min="0"
                                  :max="23"></a-input-number>
                  小时开始
                </a-radio>
              </a-row>
              <a-row>
                ...
                <a-select style="width:340px;" size="small" mode="multiple"
                  ...
                  <a-select-option v-for="(val,index) in Array(24)" :key="index">{{ index }}
                  </a-select-option>
                </a-select>
              </a-row>
              <a-row>
                <a-radio value="4">周期从
                  <a-input-number size="small" v-model="result.hour.rangeStart" :min="0"
                                  :max="23"></a-input-number>
                  到
                  <a-input-number size="small" v-model="result.hour.rangeEnd" :min="0"
                                  :max="23"></a-input-number>
                  小时
                </a-radio>
              </a-row>
            ...
            <a-radio-group v-model="result.day.cronEvery">
              ...
              <a-row>
                <a-radio value="3">每隔
                  ...
                  天执行 从
                  <a-input-number size="small" v-model="result.day.incrementStart" :min="1"
                                  :max="31"></a-input-number>
                  天开始
                </a-radio>
              </a-row>
              ...
              <a-row>
                <a-radio value="11">在这个月的第
                  <a-input-number size="small" v-model="result.week.cronNthDayNth" :min="1"
        ...
        <a-tab-pane key="5">
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.month.cronEvery">
              ...
              <a-row>
                <a-radio value="4">从
                  <a-input-number size="small" v-model="result.month.rangeStart" :min="1"
                                  :max="12"></a-input-number>
                  到
                  <a-input-number size="small" v-model="result.month.rangeEnd" :min="1"
                                  :max="12"></a-input-number>
                  月之间的每个月
                </a-radio>
              </a-row>
              ...
              <a-row>
                <a-radio value="4">从
                  <a-input-number size="small" v-model="result.year.rangeStart" :min="2019"
                                  :max="2119"></a-input-number>
                  到
                  <a-input-number size="small" v-model="result.year.rangeEnd" :min="2019"
                                  :max="2119"></a-input-number>
                  年之间的每一年
                </a-radio>
              </a-row>
