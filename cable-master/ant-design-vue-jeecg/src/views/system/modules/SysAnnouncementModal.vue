        ...
        <a-row style="width: 100%;">
          <a-col :span="24/2">
            <a-form-item
              ...
              label="标题">
              <a-input placeholder="请输入标题" v-decorator="['titile', validatorRules.title]"
          ...
          <a-col :span="24/2">
            <a-form-item
              ...
              <j-date style="width: 100%" :getCalendarContainer="node => node.parentNode"
                      v-decorator="[ 'startTime', validatorRules.startTime]" placeholder="请选择开始时间"
                      showTime dateFormat="YYYY-MM-DD HH:mm:ss"></j-date>
            </a-form-item>
          </a-col>
          <a-col :span="24/2">
            <a-form-item
